...
<html lang="en">
    ...
    <body>
     ...
     <div class="container-fluid py-5">
          ...
          <div class="d-flex gap-3 ms-4 mb-4">
    <a href="{{ route('checkout.view') }}" 
       class="btn btn-primary rounded-pill px-4 py-2 text-uppercase fw-bold shadow-sm">
       Checkout
    </a>

    <div class="ms-auto">
        <a href="{{ route('homepage') }}" 
           class="btn btn-outline-secondary rounded-pill px-4 py-2 text-uppercase fw-bold shadow-sm">
           Back
        </a>
    </div>
</div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    function updateCart(id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Optionally reload cart content
            },
            error: function() {
                Swal.fire({
                    icon: 'error',
    ...
    function removeItemFromCart(id) {
        ...
        function updateCartTotal() {
            ...
            $('#total').text(`$${(subtotal ).toFixed(2)}`); // Assuming a flat shipping rate of $3
        }
