...
<div class="container-fluid mt-4"> {{-- Changed to full-width --}}
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('reports.export_pdf', request()->query()) }}" target="_blank" class="btn btn-outline-primary me-2 shadow-sm">
    ...
    <div class="card border-0 shadow-lg">
        <div class="card-body">
            <table id="reportsTable" class="table table-hover table-bordered table-striped align-middle text-center nowrap w-100">
...
$(function () {
    ...
    // Filters
    $('#crop_id, #region_id').on('change', function () {
        table.draw();
    });
    ...
    $('#reportsTable').on('preXhr.dt', function (e, settings, data) {
