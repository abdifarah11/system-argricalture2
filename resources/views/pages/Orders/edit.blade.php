...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">Edit Order #{{ $order->id }}</h1>
            ...
            <form action="{{ route('orders.update', $order->id) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="payment_method_id" id="payment_method_id" class="form-select">
                            ...
                            @foreach($payments as $payment)
                                <option value="{{ $payment->id }}" {{ $order->payment_method_id == $payment->id ? 'selected' : '' }}>
                                    {{ $payment->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="delivery_status" id="delivery_status" class="form-select" required>
                            ...
                            @foreach($deliveryStatuses as $dstatus)
                                <option value="{{ $dstatus }}" {{ $order->delivery_status == $dstatus ? 'selected' : '' }}>
                                    {{ ucfirst($dstatus) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="total_amount" id="total_amount" class="form-control" min="0" step="0.01" 
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="3">{{ old('description', $order->description) }}</textarea>
                    </div>
